        ...
        <Card className="bg-gray-900/50 border-gray-800 mb-8">
          <CardContent className="p-8">
            <div className="relative h-96 bg-gray-800 rounded-lg overflow-hidden">
              ...
              {/* Simulated Map Pins */}
              <div
                className="absolute top-1/4 left-1/4 w-4 h-4 bg-red-500 rounded-full animate-pulse cursor-pointer"
                onClick={() => setSelectedRace(races[0])}
              />
              <div
                className="absolute top-1/3 right-1/3 w-4 h-4 bg-blue-500 rounded-full animate-pulse cursor-pointer"
                onClick={() => setSelectedRace(races[1])}
              />
              <div
                className="absolute bottom-1/4 right-1/4 w-4 h-4 bg-green-500 rounded-full animate-pulse cursor-pointer"
